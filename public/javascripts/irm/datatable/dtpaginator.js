YUI.add("dtpaginator",function(Y){
    var TB = "<table class='paginator'><tbody><tr><td class='col1'>{goToPage}</td><td class='col2'>{prenext}</td><td class='col3'>{record}</td><td class='col4'>{perPage}</td></tr></tbody></table>";
