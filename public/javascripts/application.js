...
function pre_init_partial(el){
    ...
    $('<span class="textrequired">*&nbsp;</span>').insertBefore($(el).find("form").find('input[required]:not([readonly]):not([disabled]):not([span])'));
    $(el).find("form").find('input[required]:not([readonly]):not([disabled]):not(input[span])').attr("span", true);
    $('<span class="textrequired">&nbsp;&nbsp;</span>').insertBefore($(el).find("form").find('input:not([required]):not([span]):not([type=hidden])'));
    $(el).find("form").find('input:not(input[required]):not(input[span]):not([type=hidden])').attr("span", true);

    $('<span class="textrequired">*&nbsp;</span>').insertBefore($(el).find("form").find('textarea[required]:not([readonly]):not([disabled]):not([span])'));
    $(el).find("form").find('textarea[required]:not([readonly]):not([disabled]):not([span])').attr("span", true);
    $('<span class="textrequired">&nbsp;&nbsp;</span>').insertBefore($(el).find("form").find('textarea:not([required]):not([span])'));
    $(el).find("form").find('textarea:not([required]):not([span])').attr("span", true);

    $('<span class="textrequired">*&nbsp;</span>').insertBefore($(el).find("form").find('select[required]:not([readonly]):not([disabled]):not([span])'));
