...
module Irm::OperationalCatalogsHelper
  def available_oper_cata_segment_set(segment)
    set_name = Irm::IdFlexSegment.query_by_structure_code("OPERATIONAL_CATALOG").segment(segment.to_s).first().flex_value_set_name
