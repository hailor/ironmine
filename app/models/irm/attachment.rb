class Irm::Attachment < ActiveRecord::Base
  ...
  scope :list_all, lambda{
    select("#{table_name}.*, av.id version_id, av.category_id category_id, av.data_file_name data_file_name, av.data_content_type data_content_type, av.data_file_size data_file_size, av.data_updated_at data_updated_at, fvt.meaning category_name").
