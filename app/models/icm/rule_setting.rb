class Icm::RuleSetting < ActiveRecord::Base
  ...
  scope :list_all,lambda{
    joins("LEFT OUTER JOIN #{Irm::LookupValue.view_name} ON  #{Irm::LookupValue.view_name}.lookup_type = 'ICM_PROCESS_TYPE' AND #{Irm::LookupValue.view_name}.lookup_code = #{table_name}.assignment_process_code").
