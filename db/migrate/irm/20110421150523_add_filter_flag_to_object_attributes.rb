class AddFilterFlagToObjectAttributes < ActiveRecord::Migration
  def self.up
    ...
    execute('CREATE OR REPLACE VIEW irm_object_attributes_vl AS SELECT t.*,tl.id lang_id,tl.name,tl.description,tl.value_title,tl.desc_title,tl.addition_title,tl.language,tl.source_lang
