...
class ReworkUidMenus < ActiveRecord::Migration
  def self.up
    ...
    uid_menu_entiry_109= Irm::MenuEntry.new(:menu_code=>'UID_EXTERNAL_USER_MENU',:sub_menu_code=>nil,:page_controller=>'uid/external_logins',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    uid_menu_entiry_109.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'外部 Login ID',:description=>'外部 Login ID')
    uid_menu_entiry_109.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'External Login ID',:description=>'External Login ID')
    ...
    uid_menu_entiry_111= Irm::MenuEntry.new(:menu_code=>'UID_EXTERNAL_USER_MENU',:sub_menu_code=>nil,:page_controller=>'uid/auto_mappings',:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
    uid_menu_entiry_111.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'自动匹配',:description=>'自动匹配')
    uid_menu_entiry_111.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Auto Mapping',:description=>'Auto Mapping')
    uid_menu_entiry_111.save
    uid_menu_entiry_112= Irm::MenuEntry.new(:menu_code=>'UID_EXTERNAL_USER_MENU',:sub_menu_code=>nil,:page_controller=>'uid/import_files',:display_sequence=>50,:display_flag=>'Y',:not_auto_mult=>true)
    uid_menu_entiry_112.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'导入文件',:description=>'导入文件')
    uid_menu_entiry_112.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Import Files',:description=>'Import Files')
