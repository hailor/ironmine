...
class AddOperationalCatalogsIdFlexData < ActiveRecord::Migration
  def self.up
    id_flex = Irm::IdFlex.new(:id_flex_code => "CATALOGS", :id_flex_name => "Operational Catalog Id Flexes", :status_code => "ENABLED")
    id_flex.save

    id_flex_structure = Irm::IdFlexStructure.new(:id_flex_code => "CATALOGS", :id_flex_num => 100, :id_flex_structure_code => "OPERATIONAL_CATALOG", :status_code => "ENABLED", :concatenated_segment_delimiter => '-',:not_auto_mult=>true)
    id_flex_structure.id_flex_structures_tls.build(:id_flex_structure_name => "Operational Catalog", :language => "zh", :source_lang => "zh", :status_code => "ENABLED")
    id_flex_structure.id_flex_structures_tls.build(:id_flex_structure_name => "Operational Catalog", :language => "en", :source_lang => "zh", :status_code => "ENABLED")
    id_flex_structure.save

    id_flex_segment1 = Irm::IdFlexSegment.new(:id_flex_code => "CATALOGS", :id_flex_num => 100, :segment_num => 10,
    ...
    id_flex_segment2 = Irm::IdFlexSegment.new(:id_flex_code => "CATALOGS", :id_flex_num => 100,:segment_num => 20,
    ...
    id_flex_segment3 = Irm::IdFlexSegment.new(:id_flex_code => "CATALOGS", :id_flex_num => 100,:segment_num => 30,
