...
class InitWfTaskPermissionData < ActiveRecord::Migration
  def self.up
    irm_edit_wf_tasks= Irm::Function.new(:group_code=>'IRM_WF_TASK',:function_code=>'EDIT_WF_TASKS',:default_flag=>'N',:public_flag=>'N',:not_auto_mult=>true)
    ...
    irm_create_wf_tasks= Irm::Function.new(:group_code=>'IRM_WF_TASK',:function_code=>'CREATE_WF_TASKS',:default_flag=>'N',:public_flag=>'N',:not_auto_mult=>true)
    ...
    irm_view_wf_tasks= Irm::Function.new(:group_code=>'IRM_WF_TASK',:function_code=>'VIEW_WF_TASKS',:default_flag=>'N',:public_flag=>'N',:not_auto_mult=>true)
