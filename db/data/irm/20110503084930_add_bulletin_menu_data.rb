...
class AddBulletinMenuData < ActiveRecord::Migration
  def self.up
    irm_menu_entiry_111= Irm::MenuEntry.new(:menu_code=>'HOME',:sub_menu_code=>nil,:page_controller=>'irm/bulletins',:display_sequence=>50,:display_flag=>'N',:not_auto_mult=>true)
