...
class InitFilterOperatorLookup < ActiveRecord::Migration
  def self.up
    ...
    n= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'N',:start_date_active=>'2011-02-21',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    n.save
    g= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'G',:start_date_active=>'2011-02-22',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    g.save
    l= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'L',:start_date_active=>'2011-02-23',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    l.save
    m= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'M',:start_date_active=>'2011-02-24',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    m.save
    h= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'H',:start_date_active=>'2011-02-25',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    h.save
    isnil= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'NIL',:start_date_active=>'2011-02-26',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    isnil.save
    nnil= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'NNIL',:start_date_active=>'2011-02-27',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    nnil.save
    bw= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'BW',:start_date_active=>'2011-02-28',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    bw.save
    ew= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'EW',:start_date_active=>'2011-03-01',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    ew.save
    u= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'U',:start_date_active=>'2011-03-02',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    u.save
    x= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'X',:start_date_active=>'2011-03-03',:status_code=>'ENABLED',:not_auto_mult=>true)
    ...
    x.save
    isin= Irm::LookupValue.new(:lookup_type=>'',:lookup_code=>'IN',:start_date_active=>'2011-03-04',:status_code=>'ENABLED',:not_auto_mult=>true)
