...
class ReworkMenu < ActiveRecord::Migration
  def self.up
    ...
    irm_menu_entiry_4.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'我的个人信息',:description=>'设置个人信息，修改密码')
    ...
    irm_menu_entiry_5.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'我的账号',:description=>'个人账号')
    irm_menu_entiry_5.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'My identity',:description=>'My identity')
    ...
    irm_menu_entiry_6.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'修改密码',:description=>'修改密码')
    ...
    irm_menu_entiry_7= Irm::MenuEntry.new(:menu_code=>'IRM_SETTING_ENTRANCE_MENU',:sub_menu_code=>'IRM_SYSTEM_SETTING_MENU',:page_controller=>nil,:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_7.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'系统设置',:description=>'系统设置')
    irm_menu_entiry_7.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'System setting',:description=>'System setting')
    irm_menu_entiry_7.save
    irm_menu_entiry_8= Irm::MenuEntry.new(:menu_code=>'IRM_SYSTEM_SETTING_MENU',:sub_menu_code=>'IRM_BASE_SETTING_MENU',:page_controller=>nil,:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_8.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'基础设置',:description=>'基础设置')
    irm_menu_entiry_8.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Base setting',:description=>'Base setting')
    irm_menu_entiry_8.save
    irm_menu_entiry_9= Irm::MenuEntry.new(:menu_code=>'IRM_BASE_SETTING_MENU',:sub_menu_code=>'IRM_COMMON_SETTING_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_9.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'常用设置',:description=>'常用设置')
    irm_menu_entiry_9.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Common setting',:description=>'Common setting')
    irm_menu_entiry_9.save
    irm_menu_entiry_10= Irm::MenuEntry.new(:menu_code=>'IRM_COMMON_SETTING_MENU',:sub_menu_code=>nil,:page_controller=>'irm/global_settings',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_10.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'全局设置',:description=>'全局设置')
    irm_menu_entiry_10.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Global setting',:description=>'Global setting')
    irm_menu_entiry_10.save
    irm_menu_entiry_11= Irm::MenuEntry.new(:menu_code=>'IRM_COMMON_SETTING_MENU',:sub_menu_code=>nil,:page_controller=>'irm/auth_sources',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_11.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'LDAP认证',:description=>'LDAP认证')
    irm_menu_entiry_11.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'LDAP authsource',:description=>'LDAP authsource')
    irm_menu_entiry_11.save
    irm_menu_entiry_12= Irm::MenuEntry.new(:menu_code=>'IRM_PERMISSION_MENU',:sub_menu_code=>'IRM_COMMON_MENUS_MENU',:page_controller=>nil,:display_sequence=>35,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_12.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'菜单',:description=>'菜单')
    irm_menu_entiry_12.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Menu',:description=>'Menu')
    irm_menu_entiry_12.save
    irm_menu_entiry_13= Irm::MenuEntry.new(:menu_code=>'IRM_COMMON_MENUS_MENU',:sub_menu_code=>nil,:page_controller=>'irm/menus',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_13.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'菜单',:description=>'菜单')
    irm_menu_entiry_13.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Menu',:description=>'Menu')
    irm_menu_entiry_13.save
    irm_menu_entiry_14= Irm::MenuEntry.new(:menu_code=>'IRM_COMMON_MENUS_MENU',:sub_menu_code=>nil,:page_controller=>'irm/menu_entries',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_14.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'菜单子项',:description=>'菜单子项')
    irm_menu_entiry_14.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Menu entry',:description=>'Menu entry')
    ...
    irm_menu_entiry_36= Irm::MenuEntry.new(:menu_code=>'IRM_BASE_SETTING_MENU',:sub_menu_code=>'IRM_PERMISSION_MENU',:page_controller=>nil,:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_36.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'权限',:description=>'权限')
    irm_menu_entiry_36.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Permission',:description=>'Permission')
    irm_menu_entiry_36.save
    irm_menu_entiry_37= Irm::MenuEntry.new(:menu_code=>'IRM_PERMISSION_MENU',:sub_menu_code=>nil,:page_controller=>'irm/identities',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_37.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'账号',:description=>'账号')
    irm_menu_entiry_37.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Identity',:description=>'Identity')
    irm_menu_entiry_37.save
    irm_menu_entiry_38= Irm::MenuEntry.new(:menu_code=>'IRM_PERMISSION_MENU',:sub_menu_code=>'IRM_PERMISSION_PEOPLE_MENU',:page_controller=>nil,:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_38.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'人员',:description=>'人员')
    irm_menu_entiry_38.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'People',:description=>'People')
    irm_menu_entiry_38.save
    irm_menu_entiry_39= Irm::MenuEntry.new(:menu_code=>'IRM_PERMISSION_PEOPLE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/people',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_39.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'人员',:description=>'人员')
    irm_menu_entiry_39.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'People',:description=>'People')
    irm_menu_entiry_39.save
    irm_menu_entiry_40= Irm::MenuEntry.new(:menu_code=>'IRM_PERMISSION_PEOPLE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/company_accesses',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_40.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'人员访问公司限制',:description=>'人员访问公司限制')
    irm_menu_entiry_40.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Company access',:description=>'Company access')
    ...
    irm_menu_entiry_42= Irm::MenuEntry.new(:menu_code=>'IRM_PERMISSION_MENU',:sub_menu_code=>nil,:page_controller=>'irm/function_groups',:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_42.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'功能组',:description=>'功能组')
    irm_menu_entiry_42.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Functon group',:description=>'Function group')
    irm_menu_entiry_42.save
    irm_menu_entiry_43= Irm::MenuEntry.new(:menu_code=>'IRM_PERMISSION_MENU',:sub_menu_code=>nil,:page_controller=>'irm/functions',:display_sequence=>50,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_43.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'功能',:description=>'功能')
    irm_menu_entiry_43.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Function',:description=>'Function')
    irm_menu_entiry_43.save
    irm_menu_entiry_44= Irm::MenuEntry.new(:menu_code=>'IRM_PERMISSION_MENU',:sub_menu_code=>nil,:page_controller=>'irm/permissions',:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_44.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'权限',:description=>'权限')
    irm_menu_entiry_44.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Permission',:description=>'Permission')
    irm_menu_entiry_44.save
    irm_menu_entiry_45= Irm::MenuEntry.new(:menu_code=>'IRM_BASE_SETTING_MENU',:sub_menu_code=>'IRM_REPORT_TOP_MENU',:page_controller=>nil,:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_45.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'报表管理',:description=>'报表管理')
    irm_menu_entiry_45.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Report manage',:description=>'Report manage')
    irm_menu_entiry_45.save
    irm_menu_entiry_46= Irm::MenuEntry.new(:menu_code=>'IRM_REPORT_TOP_MENU',:sub_menu_code=>'IRM_REPORT_GROUP_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_46.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'报表组',:description=>'报表组')
    irm_menu_entiry_46.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Report group',:description=>'Report group')
    irm_menu_entiry_46.save
    irm_menu_entiry_47= Irm::MenuEntry.new(:menu_code=>'IRM_REPORT_GROUP_MENU',:sub_menu_code=>nil,:page_controller=>'irm/report_groups',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_47.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'报表组',:description=>'报表组')
    irm_menu_entiry_47.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Report group',:description=>'Report group')
    irm_menu_entiry_47.save
    irm_menu_entiry_48= Irm::MenuEntry.new(:menu_code=>'IRM_REPORT_GROUP_MENU',:sub_menu_code=>nil,:page_controller=>'irm/report_group_members',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_48.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'报表组成员',:description=>'报表组成员')
    irm_menu_entiry_48.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Report group member',:description=>'Report group member')
    irm_menu_entiry_48.save
    irm_menu_entiry_49= Irm::MenuEntry.new(:menu_code=>'IRM_REPORT_TOP_MENU',:sub_menu_code=>nil,:page_controller=>'irm/reports',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_49.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'报表',:description=>'报表')
    irm_menu_entiry_49.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Report',:description=>'Report')
    irm_menu_entiry_49.save
    icm_menu_entiry_50= Irm::MenuEntry.new(:menu_code=>'IRM_SYSTEM_SETTING_MENU',:sub_menu_code=>'ICM_ADMIN_SETTING_MENU',:page_controller=>nil,:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_50.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故管理设置',:description=>'事故管理设置')
    icm_menu_entiry_50.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident admin setting',:description=>'Incident admin setting')
    icm_menu_entiry_50.save
    icm_menu_entiry_51= Irm::MenuEntry.new(:menu_code=>'ICM_ADMIN_SETTING_MENU',:sub_menu_code=>'ICM_ADMIN_GENERAL_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_51.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'一般设置',:description=>'一般设置')
    icm_menu_entiry_51.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'General setting',:description=>'General setting')
    icm_menu_entiry_51.save
    icm_menu_entiry_52= Irm::MenuEntry.new(:menu_code=>'ICM_ADMIN_GENERAL_MENU',:sub_menu_code=>nil,:page_controller=>'icm/rule_settings',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_52.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'规则设置',:description=>'规则设置')
    icm_menu_entiry_52.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Rule setting',:description=>'Rule setting')
    icm_menu_entiry_52.save
    icm_menu_entiry_53= Irm::MenuEntry.new(:menu_code=>'ICM_ADMIN_SETTING_MENU',:sub_menu_code=>'ICM_ADMIN_INCIDENT_MENU',:page_controller=>nil,:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_53.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故',:description=>'事故')
    icm_menu_entiry_53.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident',:description=>'Incident')
    icm_menu_entiry_53.save
    icm_menu_entiry_54= Irm::MenuEntry.new(:menu_code=>'ICM_ADMIN_INCIDENT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/urgence_codes',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_54.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'紧急度',:description=>'紧急度')
    icm_menu_entiry_54.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Urgency',:description=>'Urgency')
    icm_menu_entiry_54.save
    icm_menu_entiry_55= Irm::MenuEntry.new(:menu_code=>'ICM_ADMIN_INCIDENT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/impact_ranges',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_55.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'影响度',:description=>'影响度')
    icm_menu_entiry_55.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Impact range',:description=>'Impact range')
    icm_menu_entiry_55.save
    icm_menu_entiry_56= Irm::MenuEntry.new(:menu_code=>'ICM_ADMIN_INCIDENT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/priority_codes',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
    ...
    icm_menu_entiry_58= Irm::MenuEntry.new(:menu_code=>'ICM_ADMIN_INCIDENT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/incident_phases',:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_58.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故单阶段',:description=>'事故单位阶段')
    icm_menu_entiry_58.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident phase',:description=>'Incident phase')
    icm_menu_entiry_58.save
    icm_menu_entiry_59= Irm::MenuEntry.new(:menu_code=>'ICM_ADMIN_INCIDENT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/incident_statuses',:display_sequence=>50,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_59.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故单状态',:description=>'事故单位状态')
    icm_menu_entiry_59.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident status',:description=>'Incident status')
    icm_menu_entiry_59.save
    icm_menu_entiry_60= Irm::MenuEntry.new(:menu_code=>'ICM_ADMIN_INCIDENT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/close_reasons',:display_sequence=>60,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_60.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'关闭原因',:description=>'关闭原因')
    icm_menu_entiry_60.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Close reason',:description=>'Close reason')
    icm_menu_entiry_60.save
    skm_menu_entiry_61= Irm::MenuEntry.new(:menu_code=>'IRM_SYSTEM_SETTING_MENU',:sub_menu_code=>'SKM_ADMIN_MENU',:page_controller=>nil,:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_61.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库管理',:description=>'知识库管理')
    skm_menu_entiry_61.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Service knowledge admin',:description=>'Service knowledge admin')
    skm_menu_entiry_61.save
    skm_menu_entiry_62= Irm::MenuEntry.new(:menu_code=>'SKM_ADMIN_MENU',:sub_menu_code=>'SKM_ADMIN_GENERAL_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_62.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'一般设置',:description=>'一般设置')
    skm_menu_entiry_62.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'General setting',:description=>'General setting')
    skm_menu_entiry_62.save
    skm_menu_entiry_63= Irm::MenuEntry.new(:menu_code=>'SKM_ADMIN_GENERAL_MENU',:sub_menu_code=>nil,:page_controller=>'skm/entry_statuses',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_63.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库状态',:description=>'知识库状态')
    skm_menu_entiry_63.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Entry status',:description=>'Entry status')
    skm_menu_entiry_63.save
    skm_menu_entiry_64= Irm::MenuEntry.new(:menu_code=>'SKM_ADMIN_GENERAL_MENU',:sub_menu_code=>nil,:page_controller=>'skm/entry_templates',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_64.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库模板',:description=>'知识库模板')
    skm_menu_entiry_64.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Entry template',:description=>'Entry template')
    skm_menu_entiry_64.save
    skm_menu_entiry_65= Irm::MenuEntry.new(:menu_code=>'SKM_ADMIN_GENERAL_MENU',:sub_menu_code=>nil,:page_controller=>'skm/entry_template_elements',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_65.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库模板元素',:description=>'知识库模板元素')
    skm_menu_entiry_65.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Entry template element',:description=>'Entry template element')
    skm_menu_entiry_65.save
    irm_menu_entiry_66= Irm::MenuEntry.new(:menu_code=>'IRM_SYSTEM_SETTING_MENU',:sub_menu_code=>'IRM_ADVANCE_SETTING_MENU',:page_controller=>nil,:display_sequence=>50,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_66.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'高级设置',:description=>'高级设置')
    irm_menu_entiry_66.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Advance setting',:description=>'Advance setting')
    irm_menu_entiry_66.save
    irm_menu_entiry_67= Irm::MenuEntry.new(:menu_code=>'IRM_ADVANCE_SETTING_MENU',:sub_menu_code=>'IRM_ADVANCE_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_67.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'高级',:description=>'高级')
    irm_menu_entiry_67.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Advance',:description=>'Advance')
    irm_menu_entiry_67.save
    irm_menu_entiry_68= Irm::MenuEntry.new(:menu_code=>'IRM_ADVANCE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/currencies',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_68.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'币种',:description=>'币种')
    irm_menu_entiry_68.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Currency',:description=>'Currency')
    irm_menu_entiry_68.save
    irm_menu_entiry_69= Irm::MenuEntry.new(:menu_code=>'IRM_ADVANCE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/languages',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_69.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'语言',:description=>'语言')
    irm_menu_entiry_69.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Language',:description=>'Language')
    irm_menu_entiry_69.save
    irm_menu_entiry_70= Irm::MenuEntry.new(:menu_code=>'IRM_ADVANCE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/product_modules',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_70.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'产品模块',:description=>'产品模块')
    irm_menu_entiry_70.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Product module',:description=>'Product module')
    irm_menu_entiry_70.save
    irm_menu_entiry_71= Irm::MenuEntry.new(:menu_code=>'IRM_ADVANCE_SETTING_MENU',:sub_menu_code=>'IRM_MAIL_MENU',:page_controller=>nil,:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_71.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'邮件',:description=>'邮件')
    irm_menu_entiry_71.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Mail',:description=>'Mail')
    irm_menu_entiry_71.save
    irm_menu_entiry_72= Irm::MenuEntry.new(:menu_code=>'IRM_MAIL_MENU',:sub_menu_code=>nil,:page_controller=>'irm/conditions',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_72.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'Condition',:description=>'Condition')
    irm_menu_entiry_72.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Condition',:description=>'Condition')
    irm_menu_entiry_72.save
    irm_menu_entiry_73= Irm::MenuEntry.new(:menu_code=>'IRM_MAIL_MENU',:sub_menu_code=>nil,:page_controller=>'irm/actions',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_73.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'Action',:description=>'Action')
    irm_menu_entiry_73.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Action',:description=>'Action')
    irm_menu_entiry_73.save
    irm_menu_entiry_74= Irm::MenuEntry.new(:menu_code=>'IRM_MAIL_MENU',:sub_menu_code=>nil,:page_controller=>'irm/scripts',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_74.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'Script',:description=>'Script')
    irm_menu_entiry_74.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Script',:description=>'Script')
    irm_menu_entiry_74.save
    irm_menu_entiry_75= Irm::MenuEntry.new(:menu_code=>'IRM_MAIL_MENU',:sub_menu_code=>nil,:page_controller=>'irm/mail_templates',:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_75.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'邮件模板',:description=>'邮件模板')
    irm_menu_entiry_75.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Mail template',:description=>'Mail template')
    irm_menu_entiry_75.save
    irm_menu_entiry_76= Irm::MenuEntry.new(:menu_code=>'IRM_ENTRANCE_MENU',:sub_menu_code=>'IRM_SERVICE_OPERATION_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_76.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'服务中心',:description=>'服务中心')
    irm_menu_entiry_76.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Service center',:description=>'Service center')
    irm_menu_entiry_76.save
    irm_menu_entiry_77= Irm::MenuEntry.new(:menu_code=>'IRM_SERVICE_OPERATION_MENU',:sub_menu_code=>'IRM_SOC_HOME_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_77.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'主页',:description=>'主页')
    irm_menu_entiry_77.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Home',:description=>'Home')
    irm_menu_entiry_77.save
    irm_menu_entiry_78= Irm::MenuEntry.new(:menu_code=>'IRM_SOC_HOME_MENU',:sub_menu_code=>nil,:page_controller=>'irm/home',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    ...
    icm_menu_entiry_79= Irm::MenuEntry.new(:menu_code=>'IRM_SERVICE_OPERATION_MENU',:sub_menu_code=>'IRM_SOC_INCIDENT_MENU',:page_controller=>nil,:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_79.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故',:description=>'事故')
    icm_menu_entiry_79.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident',:description=>'Incident')
    icm_menu_entiry_79.save
    icm_menu_entiry_80= Irm::MenuEntry.new(:menu_code=>'IRM_SOC_INCIDENT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/incident_requests',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_80.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故单',:description=>'事故单')
    icm_menu_entiry_80.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident request',:description=>'Incident request')
    icm_menu_entiry_80.save
    icm_menu_entiry_81= Irm::MenuEntry.new(:menu_code=>'IRM_SOC_INCIDENT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/incident_journals',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    icm_menu_entiry_81.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故单回复',:description=>'事故单回复')
    icm_menu_entiry_81.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident request journal',:description=>'Incident request journal')
    icm_menu_entiry_81.save
    csi_menu_entiry_82= Irm::MenuEntry.new(:menu_code=>'IRM_SERVICE_OPERATION_MENU',:sub_menu_code=>'IRM_SOC_SURVEY_MENU',:page_controller=>nil,:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
    csi_menu_entiry_82.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'调查问卷',:description=>'调查问卷')
    csi_menu_entiry_82.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Survery',:description=>'Survery')
    csi_menu_entiry_82.save
    csi_menu_entiry_83= Irm::MenuEntry.new(:menu_code=>'IRM_SOC_SURVEY_MENU',:sub_menu_code=>nil,:page_controller=>'csi/surveys',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    csi_menu_entiry_83.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'调查问卷',:description=>'调查问卷')
    csi_menu_entiry_83.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Survery',:description=>'Survery')
    csi_menu_entiry_83.save
    csi_menu_entiry_84= Irm::MenuEntry.new(:menu_code=>'IRM_SOC_SURVEY_MENU',:sub_menu_code=>nil,:page_controller=>'csi/survey_subjects',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    csi_menu_entiry_84.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'调查问题',:description=>'调查问题')
    csi_menu_entiry_84.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Survery subject',:description=>'Survery subject')
    csi_menu_entiry_84.save
    csi_menu_entiry_85= Irm::MenuEntry.new(:menu_code=>'IRM_SOC_SURVEY_MENU',:sub_menu_code=>nil,:page_controller=>'csi/survey_ranges',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
    csi_menu_entiry_85.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'调查问卷范围',:description=>'调查问卷范围')
    csi_menu_entiry_85.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Survery range',:description=>'Survery range')
    csi_menu_entiry_85.save
    skm_menu_entiry_86= Irm::MenuEntry.new(:menu_code=>'IRM_SERVICE_OPERATION_MENU',:sub_menu_code=>'IRM_SOC_SERVICE_KNOWLEDGE_MENU',:page_controller=>nil,:display_sequence=>50,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_86.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库',:description=>'知识库')
    skm_menu_entiry_86.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Service knowledge',:description=>'Service knowledge')
    skm_menu_entiry_86.save
    skm_menu_entiry_87= Irm::MenuEntry.new(:menu_code=>'IRM_SOC_SERVICE_KNOWLEDGE_MENU',:sub_menu_code=>nil,:page_controller=>'skm/entry_headers',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_87.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库文章',:description=>'知识库文章')
    skm_menu_entiry_87.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Service knowledge',:description=>'Service knowledge')
    skm_menu_entiry_87.save
    skm_menu_entiry_88= Irm::MenuEntry.new(:menu_code=>'IRM_SERVICE_OPERATION_MENU',:sub_menu_code=>'IRM_SOC_FILE_MANAGEMENT_MENU',:page_controller=>nil,:display_sequence=>60,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_88.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'文件管理',:description=>'文件管理')
    skm_menu_entiry_88.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'File Management',:description=>'File Management')
    skm_menu_entiry_88.save
    skm_menu_entiry_89= Irm::MenuEntry.new(:menu_code=>'IRM_SOC_FILE_MANAGEMENT_MENU',:sub_menu_code=>nil,:page_controller=>'skm/file_managements',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_89.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'文件管理',:description=>'文件管理')
    skm_menu_entiry_89.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'File Management',:description=>'File Management')
    skm_menu_entiry_89.save
    irm_menu_entiry_90= Irm::MenuEntry.new(:menu_code=>'IRM_SETTING_ENTRANCE_MENU',:sub_menu_code=>'IRM_DEVELOPER_TOOLS_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_90.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'开发工人员工具',:description=>'开发工人员工具')
    irm_menu_entiry_90.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Developer tools',:description=>'Developer tools')
    irm_menu_entiry_90.save
    irm_menu_entiry_91= Irm::MenuEntry.new(:menu_code=>'IRM_DEVELOPER_TOOLS_MENU',:sub_menu_code=>'IRM_DEV_HEPLER_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_91.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'开发工具',:description=>'开发工具')
    irm_menu_entiry_91.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Developer tools',:description=>'Developer tools')
    irm_menu_entiry_91.save
    irm_menu_entiry_92= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_HEPLER_MENU',:sub_menu_code=>nil,:page_controller=>'irm/dev_tools',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    irm_menu_entiry_92.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'工具列表',:description=>'工具列表')
    irm_menu_entiry_92.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Tool list',:description=>'Tool list')
