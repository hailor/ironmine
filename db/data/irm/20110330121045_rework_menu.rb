...
class ReworkMenu < ActiveRecord::Migration
  def self.up
    ...
    irm_irm_setting_entrance_menu.menus_tls.build(:language=>'zh',:source_lang=>'en',:name=>'通用设置',:description=>'通用设置菜单')
    irm_irm_setting_entrance_menu.menus_tls.build(:language=>'en',:source_lang=>'en',:name=>'General Setting',:description=>'General Setting menu')
    ...
    irm_irm_entrance_menu.menus_tls.build(:language=>'zh',:source_lang=>'en',:name=>'通用业务',:description=>'通用业务菜单')
    irm_irm_entrance_menu.menus_tls.build(:language=>'en',:source_lang=>'en',:name=>'General Bussiness',:description=>'General Bussiness menu')
    ...
    irm_uid_global_management_menu= Irm::Menu.new(:menu_code=>'UID_GLOBAL_MANAGEMENT_MENU',:leaf_flag=>'N',:not_auto_mult=>true)
    irm_uid_global_management_menu.menus_tls.build(:language=>'zh',:source_lang=>'en',:name=>'统一用户',:description=>'统一用户菜单')
    irm_uid_global_management_menu.menus_tls.build(:language=>'en',:source_lang=>'en',:name=>'Global User Management',:description=>'Global User Management Menu')
    irm_uid_global_management_menu.save
    irm_uid_org_structure_menu= Irm::Menu.new(:menu_code=>'UID_ORG_STRUCTURE_MENU',:leaf_flag=>'Y',:not_auto_mult=>true)
    irm_uid_org_structure_menu.menus_tls.build(:language=>'zh',:source_lang=>'en',:name=>'人员',:description=>'人员')
    irm_uid_org_structure_menu.menus_tls.build(:language=>'en',:source_lang=>'en',:name=>'People',:description=>'People')
    irm_uid_org_structure_menu.save
    irm_uid_people_menu= Irm::Menu.new(:menu_code=>'UID_PEOPLE_MENU',:leaf_flag=>'Y',:not_auto_mult=>true)
    irm_uid_people_menu.menus_tls.build(:language=>'zh',:source_lang=>'en',:name=>'用户',:description=>'用户')
    irm_uid_people_menu.menus_tls.build(:language=>'en',:source_lang=>'en',:name=>'People',:description=>'People')
    irm_uid_people_menu.save
     ...
     irm_menu_entiry_65= Irm::MenuEntry.new(:menu_code=>'IRM_ENTRANCE_MENU',:sub_menu_code=>'IRM_HOME_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_65.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'主页',:description=>'主页')
     irm_menu_entiry_65.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Home',:description=>'Home')
     irm_menu_entiry_65.save
     irm_menu_entiry_66= Irm::MenuEntry.new(:menu_code=>'IRM_HOME_MENU',:sub_menu_code=>nil,:page_controller=>'irm/home',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_66.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'主页',:description=>'主页')
     irm_menu_entiry_66.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Home Page',:description=>'Home Page')
     irm_menu_entiry_66.save
     icm_menu_entiry_67= Irm::MenuEntry.new(:menu_code=>'IRM_ENTRANCE_MENU',:sub_menu_code=>'IRM_INCIDENT_MENU',:page_controller=>nil,:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     icm_menu_entiry_67.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故',:description=>'事故')
     icm_menu_entiry_67.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident',:description=>'Incident')
     icm_menu_entiry_67.save
     icm_menu_entiry_68= Irm::MenuEntry.new(:menu_code=>'IRM_INCIDENT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/incident_requests',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     icm_menu_entiry_68.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故单',:description=>'事故单')
     icm_menu_entiry_68.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident Request',:description=>'Incident Request')
     icm_menu_entiry_68.save
     icm_menu_entiry_69= Irm::MenuEntry.new(:menu_code=>'IRM_INCIDENT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/incident_journals',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     icm_menu_entiry_69.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故单回复',:description=>'事故单回复')
     icm_menu_entiry_69.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident Request Journal',:description=>'Incident Request Journal')
     icm_menu_entiry_69.save
     csi_menu_entiry_70= Irm::MenuEntry.new(:menu_code=>'IRM_ENTRANCE_MENU',:sub_menu_code=>'IRM_SURVEY_MENU',:page_controller=>nil,:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
     csi_menu_entiry_70.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'调查问卷',:description=>'调查问卷')
     ...
     csi_menu_entiry_71= Irm::MenuEntry.new(:menu_code=>'IRM_SURVEY_MENU',:sub_menu_code=>nil,:page_controller=>'csi/surveys',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     ...
     csi_menu_entiry_72= Irm::MenuEntry.new(:menu_code=>'IRM_SURVEY_MENU',:sub_menu_code=>nil,:page_controller=>'csi/survey_subjects',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     csi_menu_entiry_72.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'调查问题',:description=>'调查问题')
     csi_menu_entiry_72.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Survery Subject',:description=>'Survery Subject')
     csi_menu_entiry_72.save
     csi_menu_entiry_73= Irm::MenuEntry.new(:menu_code=>'IRM_SURVEY_MENU',:sub_menu_code=>nil,:page_controller=>'csi/survey_ranges',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
     csi_menu_entiry_73.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'调查问卷范围',:description=>'调查问卷范围')
     csi_menu_entiry_73.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Survery Range',:description=>'Survery Range')
     csi_menu_entiry_73.save
     skm_menu_entiry_74= Irm::MenuEntry.new(:menu_code=>'IRM_ENTRANCE_MENU',:sub_menu_code=>'IRM_SERVICE_KNOWLEDGE_MENU',:page_controller=>nil,:display_sequence=>50,:display_flag=>'Y',:not_auto_mult=>true)
     skm_menu_entiry_74.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库',:description=>'知识库')
     ...
     skm_menu_entiry_75= Irm::MenuEntry.new(:menu_code=>'IRM_SERVICE_KNOWLEDGE_MENU',:sub_menu_code=>nil,:page_controller=>'skm/entry_headers',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     skm_menu_entiry_75.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库文章',:description=>'知识库文章')
     ...
     skm_menu_entiry_77= Irm::MenuEntry.new(:menu_code=>'IRM_SERVICE_KNOWLEDGE_MENU',:sub_menu_code=>nil,:page_controller=>'skm/file_managements',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     ...
     irm_menu_entiry_78= Irm::MenuEntry.new(:menu_code=>'IRM_ENTRANCE_MENU',:sub_menu_code=>'IRM_REPORT_MENU',:page_controller=>nil,:display_sequence=>70,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_78.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'报表',:description=>'报表')
     irm_menu_entiry_78.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Report',:description=>'Report')
     irm_menu_entiry_78.save
     irm_menu_entiry_79= Irm::MenuEntry.new(:menu_code=>'IRM_REPORT_MENU',:sub_menu_code=>nil,:page_controller=>'irm/report_lists',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_79.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'报表列表',:description=>'报表列表')
     irm_menu_entiry_79.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Report List',:description=>'Report List')
     irm_menu_entiry_79.save
     icm_menu_entiry_80= Irm::MenuEntry.new(:menu_code=>'IRM_REPORT_MENU',:sub_menu_code=>nil,:page_controller=>'icm/incident_reports',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     icm_menu_entiry_80.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'事故单报表',:description=>'事故单报表')
     icm_menu_entiry_80.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Incident Report',:description=>'Incident Report')
     icm_menu_entiry_80.save
     skm_menu_entiry_81= Irm::MenuEntry.new(:menu_code=>'IRM_REPORT_MENU',:sub_menu_code=>nil,:page_controller=>'skm/entry_reports',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
     skm_menu_entiry_81.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库报表',:description=>'知识库报表')
     skm_menu_entiry_81.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Service Knowledge Report',:description=>'Service Knowledge Report')
     skm_menu_entiry_81.save
     irm_menu_entiry_82= Irm::MenuEntry.new(:menu_code=>'IRM_SETTING_ENTRANCE_MENU',:sub_menu_code=>'IRM_DEVELOPER_MENU',:page_controller=>nil,:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_82.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'应用开发员',:description=>'应用开发员')
     irm_menu_entiry_82.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Application Developer',:description=>'Application Developer')
     irm_menu_entiry_82.save
     irm_menu_entiry_83= Irm::MenuEntry.new(:menu_code=>'IRM_DEVELOPER_MENU',:sub_menu_code=>'IRM_DEV_PERMISSION_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_83.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'权限',:description=>'权限')
     irm_menu_entiry_83.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Permission',:description=>'Permission')
     irm_menu_entiry_83.save
     irm_menu_entiry_84= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_PERMISSION_MENU',:sub_menu_code=>'IRM_DEV_MENUS_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_84.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'菜单',:description=>'菜单')
     irm_menu_entiry_84.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Menu',:description=>'Menu')
     irm_menu_entiry_84.save
     irm_menu_entiry_85= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_MENUS_MENU',:sub_menu_code=>nil,:page_controller=>'irm/menus',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     ...
     irm_menu_entiry_86= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_MENUS_MENU',:sub_menu_code=>nil,:page_controller=>'irm/menu_entries',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_86.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'菜单子项',:description=>'菜单子项')
     irm_menu_entiry_86.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Menu Entry',:description=>'Menu Entry')
     irm_menu_entiry_86.save
     irm_menu_entiry_87= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_PERMISSION_MENU',:sub_menu_code=>nil,:page_controller=>'irm/function_groups',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_87.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'功能组',:description=>'功能组')
     irm_menu_entiry_87.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Function Group',:description=>'Function Group')
     irm_menu_entiry_87.save
     irm_menu_entiry_88= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_PERMISSION_MENU',:sub_menu_code=>nil,:page_controller=>'irm/functions',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_88.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'功能',:description=>'功能')
     irm_menu_entiry_88.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Function',:description=>'Function')
     irm_menu_entiry_88.save
     irm_menu_entiry_89= Irm::MenuEntry.new(:menu_code=>'IRM_DEVELOPER_MENU',:sub_menu_code=>'IRM_DEV_REPORT_MENU',:page_controller=>nil,:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_89.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'报表管理',:description=>'报表管理')
     irm_menu_entiry_89.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Report Manage',:description=>'Report Manage')
     irm_menu_entiry_89.save
     irm_menu_entiry_90= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_REPORT_MENU',:sub_menu_code=>nil,:page_controller=>'irm/reports',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_90.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'报表',:description=>'报表')
     irm_menu_entiry_90.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Report',:description=>'Report')
     irm_menu_entiry_90.save
     irm_menu_entiry_91= Irm::MenuEntry.new(:menu_code=>'IRM_DEVELOPER_MENU',:sub_menu_code=>'IRM_DEV_AUTOMATOR_MENU',:page_controller=>nil,:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_91.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'Automator',:description=>'Automator')
     irm_menu_entiry_91.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Automator',:description=>'Automator')
     irm_menu_entiry_91.save
     irm_menu_entiry_92= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_AUTOMATOR_MENU',:sub_menu_code=>nil,:page_controller=>'irm/conditions',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_92.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'Condition',:description=>'Condition')
     irm_menu_entiry_92.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Condition',:description=>'Condition')
     irm_menu_entiry_92.save
     irm_menu_entiry_93= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_AUTOMATOR_MENU',:sub_menu_code=>nil,:page_controller=>'irm/actions',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_93.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'Action',:description=>'Action')
     irm_menu_entiry_93.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Action',:description=>'Action')
     irm_menu_entiry_93.save
     irm_menu_entiry_94= Irm::MenuEntry.new(:menu_code=>'IRM_DEVELOPER_MENU',:sub_menu_code=>'IRM_DEV_ADVANCE_MENU',:page_controller=>nil,:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_94.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'高级',:description=>'高级')
     irm_menu_entiry_94.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Advance',:description=>'Advance')
     irm_menu_entiry_94.save
     irm_menu_entiry_95= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_ADVANCE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/currencies',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_95.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'币种',:description=>'币种')
     irm_menu_entiry_95.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Currency',:description=>'Currency')
     irm_menu_entiry_95.save
     irm_menu_entiry_96= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_ADVANCE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/languages',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_96.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'语言',:description=>'语言')
     irm_menu_entiry_96.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Language',:description=>'Language')
     irm_menu_entiry_96.save
     irm_menu_entiry_97= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_ADVANCE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/product_modules',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_97.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'产品模块',:description=>'产品模块')
     irm_menu_entiry_97.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Product Module',:description=>'Product Module')
     irm_menu_entiry_97.save
     irm_menu_entiry_98= Irm::MenuEntry.new(:menu_code=>'IRM_DEVELOPER_MENU',:sub_menu_code=>'IRM_DEV_HEPLER_MENU',:page_controller=>nil,:display_sequence=>50,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_98.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'开发工具',:description=>'开发工具')
     irm_menu_entiry_98.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Developer Tool',:description=>'Developer Tool')
     irm_menu_entiry_98.save
     irm_menu_entiry_99= Irm::MenuEntry.new(:menu_code=>'IRM_DEV_HEPLER_MENU',:sub_menu_code=>nil,:page_controller=>'irm/dev_tools',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_99.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'检测工具',:description=>'检测工具')
     irm_menu_entiry_99.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Detect Tool',:description=>'Detect Tool')
     irm_menu_entiry_99.save
     skm_menu_entiry_100= Irm::MenuEntry.new(:menu_code=>'SKM_ADMIN_GENERAL_MENU',:sub_menu_code=>nil,:page_controller=>'skm/settings',:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
     skm_menu_entiry_100.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库设置',:description=>'知识库设置')
     skm_menu_entiry_100.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'SKM Settings',:description=>'SKM Settings')
     skm_menu_entiry_100.save
     uid_menu_entiry_101= Irm::MenuEntry.new(:menu_code=>'UID_GLOBAL_MANAGEMENT_MENU',:sub_menu_code=>'UID_ORG_STRUCTURE_MENU',:page_controller=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     uid_menu_entiry_101.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'人员',:description=>'人员')
     uid_menu_entiry_101.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'People',:description=>'People')
     uid_menu_entiry_101.save
     irm_menu_entiry_102= Irm::MenuEntry.new(:menu_code=>'UID_ORG_STRUCTURE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/companies',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_102.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'公司',:description=>'公司')
     irm_menu_entiry_102.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Company',:description=>'Company')
     irm_menu_entiry_102.save
     irm_menu_entiry_103= Irm::MenuEntry.new(:menu_code=>'UID_ORG_STRUCTURE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/organizations',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_103.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'组织',:description=>'组织')
     irm_menu_entiry_103.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Organization',:description=>'Organization')
     irm_menu_entiry_103.save
     irm_menu_entiry_104= Irm::MenuEntry.new(:menu_code=>'UID_ORG_STRUCTURE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/departments',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_104.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'部门',:description=>'部门')
     irm_menu_entiry_104.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Department',:description=>'Department')
     irm_menu_entiry_104.save
     irm_menu_entiry_105= Irm::MenuEntry.new(:menu_code=>'UID_ORG_STRUCTURE_MENU',:sub_menu_code=>'UID_PEOPLE_MENU',:page_controller=>nil,:display_sequence=>35,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_105.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'人员',:description=>'人员')
     irm_menu_entiry_105.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'People',:description=>'People')
     irm_menu_entiry_105.save
     irm_menu_entiry_106= Irm::MenuEntry.new(:menu_code=>'UID_PEOPLE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/people',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_106.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'人员',:description=>'人员')
     irm_menu_entiry_106.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'People',:description=>'People')
     irm_menu_entiry_106.save
     irm_menu_entiry_107= Irm::MenuEntry.new(:menu_code=>'UID_PEOPLE_MENU',:sub_menu_code=>nil,:page_controller=>'irm/company_accesses',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
     irm_menu_entiry_107.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'人员访问公司限制',:description=>'人员访问公司限制')
     irm_menu_entiry_107.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Company Access',:description=>'Company Access')
