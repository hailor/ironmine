# -*- coding: utf-8 -*-
class AddIcmIncidentRequestIndexViewColumns3 < ActiveRecord::Migration
  def self.up
    ...
    column_d = Irm::ViewColumn.new({:filter_type=>"ICM_INCIDENT_REQUEST_INDEX_A",
                                    :table_name=>"icm_incident_requests",
    ...
    column_e = Irm::ViewColumn.new({:filter_type=>"ICM_INCIDENT_REQUEST_INDEX_A",
                                    :table_name=>"icm_incident_requests",
    ...
    column_f = Irm::ViewColumn.new({:filter_type=>"ICM_INCIDENT_REQUEST_INDEX_A",
                                    :table_name=>"icm_incident_requests",
