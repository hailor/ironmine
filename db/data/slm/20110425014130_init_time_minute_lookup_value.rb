# -*- coding: utf-8 -*-
class InitTimeMinuteLookupValue < ActiveRecord::Migration
  def self.up
    slm_service_minute=Irm::LookupType.new(:lookup_level=>'GLOBAL',:lookup_type=>'SLM_SERVICE_MINUTE',:status_code=>'ENABLED',:not_auto_mult=>true)
    slm_service_minute.lookup_types_tls.build(:lookup_type_id=>slm_service_minute.id,:meaning=>'服务分钟选择',:description=>'服务分钟选择',:language=>'zh',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute.lookup_types_tls.build(:lookup_type_id=>slm_service_minute.id,:meaning=>'SERVICE MINUTE CHOICE',:description=>'SERVICE MINUTE CHOICE',:language=>'en',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute.save
    ...
    slm_service_minute_25.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_15.id,:meaning=>'25',:description=>'15',:language=>'zh',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute_25.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_15.id,:meaning=>'25',:description=>'15',:language=>'en',:status_code=>'ENABLED',:source_lang=>'en')
    ...
    slm_service_minute_26.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_16.id,:meaning=>'26',:description=>'16',:language=>'zh',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute_26.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_16.id,:meaning=>'26',:description=>'16',:language=>'en',:status_code=>'ENABLED',:source_lang=>'en')
    ...
    slm_service_minute_27.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_17.id,:meaning=>'17',:description=>'17',:language=>'zh',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute_27.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_17.id,:meaning=>'17',:description=>'17',:language=>'en',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute_27.save
    slm_service_minute_28= Irm::LookupValue.new(:lookup_type=>'SLM_SERVICE_MINUTE',:lookup_code=>'18',:start_date_active=>'2011-02-20',:status_code=>'ENABLED',:not_auto_mult=>true)
    slm_service_minute_28.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_18.id,:meaning=>'18',:description=>'18',:language=>'zh',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute_28.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_18.id,:meaning=>'18',:description=>'18',:language=>'en',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute_28.save
    slm_service_minute_29= Irm::LookupValue.new(:lookup_type=>'SLM_SERVICE_MINUTE',:lookup_code=>'19',:start_date_active=>'2011-02-20',:status_code=>'ENABLED',:not_auto_mult=>true)
    slm_service_minute_29.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_19.id,:meaning=>'19',:description=>'19',:language=>'zh',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute_29.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_19.id,:meaning=>'19',:description=>'19',:language=>'en',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute_29.save
    slm_service_minute_30= Irm::LookupValue.new(:lookup_type=>'SLM_SERVICE_MINUTE',:lookup_code=>'20',:start_date_active=>'2011-02-20',:status_code=>'ENABLED',:not_auto_mult=>true)
    slm_service_minute_30.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_20.id,:meaning=>'20',:description=>'20',:language=>'zh',:status_code=>'ENABLED',:source_lang=>'en')
    slm_service_minute_30.lookup_values_tls.build(:lookup_value_id=>slm_service_minute_20.id,:meaning=>'20',:description=>'20',:language=>'en',:status_code=>'ENABLED',:source_lang=>'en')
