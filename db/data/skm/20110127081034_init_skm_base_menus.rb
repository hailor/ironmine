...
class InitSkmBaseMenus < ActiveRecord::Migration
  def self.up
    ...
    skm_menu_entiry_48= Irm::MenuEntry.new(:menu_code=>'IRM_SYSTME_SETTING_MENU',:sub_menu_code=>'SKM_ADMIN_MENU',:permission_code=>nil,:display_sequence=>40,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_48.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库管理',:description=>'知识库管理')
    skm_menu_entiry_48.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Service knowledge admin',:description=>'Service knowledge admin')
    skm_menu_entiry_48.save
    skm_menu_entiry_49= Irm::MenuEntry.new(:menu_code=>'SKM_ADMIN_MENU',:sub_menu_code=>'SKM_ADMIN_GENERAL_MENU',:permission_code=>nil,:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_49.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'一般设置',:description=>'一般设置')
    skm_menu_entiry_49.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'General setting',:description=>'General setting')
    skm_menu_entiry_49.save
    skm_menu_entiry_50= Irm::MenuEntry.new(:menu_code=>'SKM_ADMIN_GENERAL_MENU',:sub_menu_code=>nil,:permission_code=>'SKM_ENTRY_STATUSES_INDEX',:display_sequence=>10,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_50.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库存状态',:description=>'知识库存状态')
    skm_menu_entiry_50.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Entry status',:description=>'Entry status')
    skm_menu_entiry_50.save
    skm_menu_entiry_51= Irm::MenuEntry.new(:menu_code=>'SKM_ADMIN_GENERAL_MENU',:sub_menu_code=>nil,:permission_code=>'SKM_ENTRY_TEMPLATES_INDEX',:display_sequence=>20,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_51.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库模板',:description=>'知识库模板')
    skm_menu_entiry_51.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Entry template',:description=>'Entry template')
    skm_menu_entiry_51.save
    skm_menu_entiry_52= Irm::MenuEntry.new(:menu_code=>'SKM_ADMIN_GENERAL_MENU',:sub_menu_code=>nil,:permission_code=>'SKM_ENTRY_TEMPLATE_ELE_INDEX',:display_sequence=>30,:display_flag=>'Y',:not_auto_mult=>true)
    skm_menu_entiry_52.menu_entries_tls.build(:language=>'zh',:source_lang=>'en',:name=>'知识库存模板元素',:description=>'知识库存模板元素')
    skm_menu_entiry_52.menu_entries_tls.build(:language=>'en',:source_lang=>'en',:name=>'Entry template element',:description=>'Entry template element')
